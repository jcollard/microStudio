-- ============================================
-- SOLUTION FOR STEP 7: ADDING A TITLE SCREEN
-- ============================================
-- Added game_state, init_game(), updated init/update/draw/draw_ui
...
function update_respawn()
  ...
  if player.respawn_timer >= RESPAWN_DELAY then
    ...
    -- When lives <= 0, Enter does nothing (yet - wired up in Step 8)
  end
end

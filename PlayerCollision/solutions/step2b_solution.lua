-- ============================================
-- SOLUTION FOR STEP 2b: DISABLE PLAYER WHEN DESTROYED
-- ============================================
-- Added early return checks to update_player() and draw_player()

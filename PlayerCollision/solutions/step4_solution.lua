-- ============================================
-- SOLUTION FOR STEP 4: RESPAWNING THE PLAYER
-- ============================================
-- Added respawn timer, respawn_player(), update_respawn(), draw_ui()

-- ============================================
-- SOLUTION FOR STEP 6: GAME OVER SCREEN
-- ============================================
-- Updated draw_ui() and update_respawn() for game over state
-- Note: Pressing Enter on game over does nothing yet (wired up in Step 8)

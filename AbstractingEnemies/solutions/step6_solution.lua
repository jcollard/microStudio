-- ============================================
-- SOLUTION FOR STEP 5: TWO ENEMIES WITH DUPLICATION
-- ============================================
-- This step adds a second enemy and manually handles both enemies[1] and enemies[2]
-- This shows the duplication problem that will be solved with loops in Step 6

-- ============================================
-- STARTER CODE - From DestroyingEnemies Challenge
-- ============================================
-- This is your starting point for the Abstracting Enemies challenge
-- All the helper functions from before are included

-- ============================================
-- SOLUTION FOR STEP 4: UPDATE ENEMIES WITH INDEXING
-- ============================================
-- This step adds update_enemies() function using direct indexing
-- Includes all code from Step 3
...
update = function()
  update_stars()
  update_player()
  update_enemies()  -- Changed from update_eyes()
  update_eyes()
  move_lasers()
  fire_laser()
  check_collisions()

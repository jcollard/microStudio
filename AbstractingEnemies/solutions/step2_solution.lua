-- ============================================
-- SOLUTION FOR STEP 2: INIT ENEMIES WITH ONE ENEMY
-- ============================================
-- This step adds init_enemies() function
-- Includes all code from Step 1
...
init = function()
  init_stars()
  init_player()
  init_enemies()  -- Changed from init_eyes()
  init_lasers()
end

-- ============================================
-- SOLUTION FOR STEP 3: DRAW ENEMIES WITH INDEXING
-- ============================================
-- This step adds draw_enemies() function using direct indexing
-- Includes all code from Step 2
...
draw = function()
  ...
  draw_stars()
  draw_enemies()  -- Changed from draw_eyes()
  draw_eyes()
  draw_player()
  draw_lasers()
end

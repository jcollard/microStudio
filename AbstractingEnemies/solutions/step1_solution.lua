-- ============================================
-- SOLUTION FOR STEP 1: CREATE ENEMY FUNCTION
-- ============================================
-- This step adds the create_enemy() factory function
-- All the helper functions from starter_code are included

-- ===== ENEMIES TABLE AND FACTORY FUNCTION =====
enemies = {}  -- Empty table to hold all enemies

-- ============================================
-- SOLUTION FOR STEP 8: ADD BOUNDING BOXES TO LASERS
-- ============================================
-- This file shows the complete solution after finishing Step 8
-- All game objects (eyes, player, and lasers) now use bounding boxes!
...
-- --------------------------------------------
-- STEP 8: Create Laser with Bounding Box
-- --------------------------------------------
-- Custom function to create a new laser
function create_laser()
  -- STEP 8 SOLUTION: Lasers now use create_box!
  -- Note: x=0, y=200 (off-screen), size=8, vx=0 (no horizontal movement), vy=2 (moves upward)
...
-- --------------------------------------------
-- STEP 8: Draw Lasers with Bounding Boxes
-- --------------------------------------------
-- Custom function to draw all the lasers
function draw_lasers()
  for ix, laser in pairs(lasers) do
    -- STEP 8 SOLUTION: Draw laser bounding box for debugging
    draw_box(lasers[ix])
...
-- WHAT'S NEXT?
-- ============================================
-- Now that ALL game objects have bounding boxes, you're ready for:
-- 1. Add the boxes_colliding() function to detect collisions
-- 2. Detect collisions between lasers and eyes
-- 3. Add collision response (remove eyes when hit)

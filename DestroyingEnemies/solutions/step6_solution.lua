-- ============================================
-- SOLUTION FOR STEP 6: ADD BOXES_COLLIDING FUNCTION
-- ============================================
-- This file shows the complete solution after finishing Step 6
-- The boxes_colliding() function has been added for collision detection
-- Based on step5b_solution.lua
...
-- STEP 6 SOLUTION: boxes_colliding() function for collision detection

-- ============================================
-- SOLUTION FOR STEP 7: DETECT COLLISIONS & DESTROY EYES
-- ============================================
-- This file shows the complete solution after finishing Step 7
-- Laser-eye collisions are now detected and eyes are marked as destroyed
-- Based on step6_solution.lua
...
-- STEP 7 SOLUTION: Check collisions between lasers and eyes
...
update = function()
  ...
  move_lasers()
  fire_laser()
  check_collisions()  -- NEW: Check for laser-eye collisions
end

-- ============================================
-- SOLUTION FOR STEP 5B: STOP DRAWING BOTH EYES
-- ============================================
-- This file shows the complete solution after finishing Step 5b
-- Both eyes now skip drawing when destroyed
-- Based on step4_solution.lua
...
-- STEP 5B SOLUTION: Both eyes skip drawing if destroyed
function draw_eyes()

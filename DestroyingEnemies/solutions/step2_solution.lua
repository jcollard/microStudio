-- ============================================
-- SOLUTION FOR STEP 2: ADD isDestroyed PROPERTY
-- ============================================
-- This file shows the complete solution after finishing Step 2
-- Added isDestroyed property to track eye state
-- Based on starter_code.lua from Adding Boxes lesson

-- Box helper functions (from previous lessons)
...
-- STEP 2 SOLUTION: Added isDestroyed property
function init_eyes()
  eye_rotation = 0

  left_eye = create_box(0, 0, 28, 28, 0.7, 0.57575, "#FF00FF")
  left_eye.isDestroyed = false  -- NEW: Track if destroyed

  right_eye = create_box(0, 0, 28, 28, -0.6, 0.37575, "#00FFFF")
  right_eye.isDestroyed = false  -- NEW: Track if destroyed
end

-- ============================================
-- SOLUTION FOR STEP 4: SKIP MOVEMENT FOR BOTH EYES
-- ============================================
-- This file shows the complete solution after finishing Step 4
-- Both eyes now check isDestroyed before updating movement
-- Based on starter_code.lua
...
-- STEP 4 SOLUTION: Both eyes skip movement if destroyed
